...
Gtk::Widget* CtPrefDlg::build_tab_text_n_code()
{
    ...
    auto hbox_tab_width = Gtk::manage(new Gtk::Box{Gtk::Orientation::HORIZONTAL, 4/*spacing*/});
    ...
    hbox_tab_width->append(*label_tab_width);
    hbox_tab_width->append(*spinbutton_tab_width);
    ...
    auto hbox_wrapping_indent = Gtk::manage(new Gtk::Box{Gtk::Orientation::HORIZONTAL, 4/*spacing*/});
    auto label_wrapping_indent = Gtk::manage(new Gtk::Label{_("Line Wrapping Indentation")});
    label_wrapping_indent->set_xalign(0.0f);
    ...
    hbox_wrapping_indent->append(*label_wrapping_indent);
    hbox_wrapping_indent->append(*spinbutton_wrapping_indent);
    ...
    auto checkbutton_remember_vim = Gtk::manage(new Gtk::CheckButton{_("Remember VIM Mode on Startup")});
    checkbutton_remember_vim->set_active(_pConfig->rememberVimMode);
    ...
    radiobutton_cursor_blink_on->set_group(*radiobutton_cursor_blink_default);
    auto radiobutton_cursor_blink_off = Gtk::manage(new Gtk::CheckButton{_("Off")});
    radiobutton_cursor_blink_off->set_group(*radiobutton_cursor_blink_default);
    ...
    auto hbox_margins = Gtk::manage(new Gtk::Box{Gtk::Orientation::HORIZONTAL, 4/*spacing*/});
    ...
    hbox_margins->append(*label_margins_left);
    hbox_margins->append(*spinbutton_margins_left);
    hbox_margins->append(*label_margins_right);
    hbox_margins->append(*spinbutton_margins_right);

    auto hbox_space_around_lines = Gtk::manage(new Gtk::Box{Gtk::Orientation::HORIZONTAL, 4/*spacing*/});
    auto label_space_around_lines = Gtk::manage(new Gtk::Label{_("Vertical Space Around Lines")});
    label_space_around_lines->set_halign(Gtk::Align::START);
    label_space_around_lines->set_xalign(0.0f);
    ...
    hbox_space_around_lines->append(*label_space_around_lines);
    hbox_space_around_lines->append(*spinbutton_space_around_lines);

    auto hbox_relative_wrapped_space = Gtk::manage(new Gtk::Box{Gtk::Orientation::HORIZONTAL, 4/*spacing*/});
    ...
    hbox_relative_wrapped_space->append(*label_relative_wrapped_space);
    hbox_relative_wrapped_space->append(*spinbutton_relative_wrapped_space);
    hbox_relative_wrapped_space->append(*Gtk::manage(new Gtk::Label{"%"}));

    auto size_group_1 = Gtk::SizeGroup::create(Gtk::SizeGroup::Mode::HORIZONTAL);
    ...
    auto vbox_text_editor = Gtk::manage(new Gtk::Box{Gtk::Orientation::VERTICAL, 0/*spacing*/});
    vbox_text_editor->append(*hbox_tab_width);
    vbox_text_editor->append(*checkbutton_spaces_tabs);
    vbox_text_editor->append(*checkbutton_line_wrap);
    vbox_text_editor->append(*hbox_wrapping_indent);
    vbox_text_editor->append(*checkbutton_auto_indent);
    vbox_text_editor->append(*checkbutton_line_nums);
    vbox_text_editor->append(*checkbutton_scroll_last_line);
    vbox_text_editor->append(*checkbutton_remember_vim);
    vbox_text_editor->append(*hbox_space_around_lines);
    vbox_text_editor->append(*hbox_relative_wrapped_space);
    vbox_text_editor->append(*hbox_cursor_blink);
    vbox_text_editor->append(*hbox_margins);
    Gtk::Frame* frame_text_editor = new_managed_frame_with_align(_("Text Editor"), vbox_text_editor);

    auto hbox_timestamp = Gtk::manage(new Gtk::Box{Gtk::Orientation::HORIZONTAL, 4/*spacing*/});
    auto label_timestamp = Gtk::manage(new Gtk::Label{_("Timestamp Format")});
    label_timestamp->set_xalign(0.0f);
    auto entry_timestamp_format = Gtk::manage(new Gtk::Entry{});
    entry_timestamp_format->set_hexpand(true);
    entry_timestamp_format->set_text(_pConfig->timestampFormat);
    auto button_strftime_help = Gtk::manage(new Gtk::Button{});
    button_strftime_help->set_icon_name("ct_help");
    button_strftime_help->set_tooltip_text(_("Online Manual"));
    auto button_reset_timestamp_format = Gtk::manage(new Gtk::Button{});
    button_reset_timestamp_format->set_icon_name("ct_undo");
    ...
    auto hbox_selword_chars = Gtk::manage(new Gtk::Box{Gtk::Orientation::HORIZONTAL, 4/*spacing*/});
    ...
    auto size_group_2 = Gtk::SizeGroup::create(Gtk::SizeGroup::Mode::HORIZONTAL);
    size_group_2->add_widget(*label_timestamp);
    size_group_2->add_widget(*label_horizontal_rule);
    size_group_2->add_widget(*label_selword_chars);

    auto vbox_misc_all = Gtk::manage(new Gtk::Box{Gtk::Orientation::VERTICAL, 2/*spacing*/});
    ...
    checkbutton_remember_vim->signal_toggled().connect([this, checkbutton_remember_vim](){
        _pConfig->rememberVimMode = checkbutton_remember_vim->get_active();
    });
